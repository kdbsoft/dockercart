...
class ControllerDesignTranslation extends Controller {
	...
	protected function getForm() {
		...
		$data['text_form_subtitle'] = !isset($this->request->get['translation_id'])
		    ? $this->language->get('text_add_translation_subtitle')
		    : $this->language->get('text_edit_translation_subtitle');
