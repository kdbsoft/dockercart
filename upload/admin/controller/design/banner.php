...
class ControllerDesignBanner extends Controller {
	...
	protected function getForm() {
		...
		foreach ($banner_images as $key => $value) {
			...
			if (!empty($banner_image['image_portrait']) && is_file(DIR_IMAGE . $banner_image['image_portrait'])) {
				$image_portrait = $banner_image['image_portrait'];
				$thumb_portrait = $banner_image['image_portrait'];
			} else {
				$image_portrait = '';
