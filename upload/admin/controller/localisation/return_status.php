...
class ControllerLocalisationReturnStatus extends Controller {
	...
	protected function getForm() {
		...
		$data['text_form_subtitle'] = !isset($this->request->get['return_status_id'])
		    ? $this->language->get('text_add_return_status_subtitle')
		    : $this->language->get('text_edit_return_status_subtitle');
