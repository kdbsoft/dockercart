...
class ControllerLocalisationReturnReason extends Controller {
	...
	protected function getForm() {
		...
		$data['text_form_subtitle'] = !isset($this->request->get['return_reason_id'])
		    ? $this->language->get('text_add_return_reason_subtitle')
		    : $this->language->get('text_edit_return_reason_subtitle');
