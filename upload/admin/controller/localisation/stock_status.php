...
class ControllerLocalisationStockStatus extends Controller {
	...
	protected function getForm() {
		...
		$data['text_form_subtitle'] = !isset($this->request->get['stock_status_id'])
		    ? $this->language->get('text_add_stock_status_subtitle')
		    : $this->language->get('text_edit_stock_status_subtitle');
