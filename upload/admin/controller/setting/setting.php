...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			// upsert only the posted config_* keys; keeps other code='config' keys
...
//			}
		...
		// Multilingual fields - store as arrays in _i18n fields
		if (isset($this->request->post['config_meta_title_i18n'])) {
			$data['config_meta_title_i18n'] = $this->request->post['config_meta_title_i18n'];
		} elseif ($this->config->get('config_meta_title_i18n')) {
			$data['config_meta_title_i18n'] = $this->config->get('config_meta_title_i18n');
		} else {
			$data['config_meta_title_i18n'] = array();
		}

		if (isset($this->request->post['config_meta_description_i18n'])) {
			$data['config_meta_description_i18n'] = $this->request->post['config_meta_description_i18n'];
		} elseif ($this->config->get('config_meta_description_i18n')) {
			$data['config_meta_description_i18n'] = $this->config->get('config_meta_description_i18n');
		} else {
			$data['config_meta_description_i18n'] = array();
		}

		if (isset($this->request->post['config_meta_keyword_i18n'])) {
			$data['config_meta_keyword_i18n'] = $this->request->post['config_meta_keyword_i18n'];
		} elseif ($this->config->get('config_meta_keyword_i18n')) {
			$data['config_meta_keyword_i18n'] = $this->config->get('config_meta_keyword_i18n');
		} else {
			$data['config_meta_keyword_i18n'] = array();
		}

		// Original fields - keep as strings for compatibility (default language)
		...
		// Multilingual store fields
		if (isset($this->request->post['config_name_i18n'])) {
			$data['config_name_i18n'] = $this->request->post['config_name_i18n'];
		} elseif ($this->config->get('config_name_i18n')) {
			$data['config_name_i18n'] = $this->config->get('config_name_i18n');
		} else {
			$data['config_name_i18n'] = array();
		}

		if (isset($this->request->post['config_owner_i18n'])) {
			$data['config_owner_i18n'] = $this->request->post['config_owner_i18n'];
		} elseif ($this->config->get('config_owner_i18n')) {
			$data['config_owner_i18n'] = $this->config->get('config_owner_i18n');
		} else {
			$data['config_owner_i18n'] = array();
		}

		if (isset($this->request->post['config_address_i18n'])) {
			$data['config_address_i18n'] = $this->request->post['config_address_i18n'];
		} elseif ($this->config->get('config_address_i18n')) {
			$data['config_address_i18n'] = $this->config->get('config_address_i18n');
		} else {
			$data['config_address_i18n'] = array();
		}

		// Original fields - keep as strings for compatibility
		...
		if (isset($this->request->post['config_open_i18n'])) {
			$data['config_open_i18n'] = $this->request->post['config_open_i18n'];
		} elseif ($this->config->get('config_open_i18n')) {
			$data['config_open_i18n'] = $this->config->get('config_open_i18n');
		} else {
			$data['config_open_i18n'] = array();
		}

		if (isset($this->request->post['config_comment_i18n'])) {
			$data['config_comment_i18n'] = $this->request->post['config_comment_i18n'];
		} elseif ($this->config->get('config_comment_i18n')) {
			$data['config_comment_i18n'] = $this->config->get('config_comment_i18n');
		} else {
			$data['config_comment_i18n'] = array();
		}
	...
	protected function validate() {
		...
		if (isset($this->request->post['config_meta_title_i18n'])) {
			...
			// Sync default language value to original field for backward compatibility
			$default_lang_id = $this->config->get('config_language_id');
			if (isset($this->request->post['config_meta_title_i18n'][$default_lang_id])) {
				$this->request->post['config_meta_title'] = $this->request->post['config_meta_title_i18n'][$default_lang_id];
			}
		}

		if (isset($this->request->post['config_meta_description_i18n'])) {
			$default_lang_id = $this->config->get('config_language_id');
			if (isset($this->request->post['config_meta_description_i18n'][$default_lang_id])) {
				$this->request->post['config_meta_description'] = $this->request->post['config_meta_description_i18n'][$default_lang_id];
			}
		}

		if (isset($this->request->post['config_meta_keyword_i18n'])) {
			$default_lang_id = $this->config->get('config_language_id');
			if (isset($this->request->post['config_meta_keyword_i18n'][$default_lang_id])) {
				$this->request->post['config_meta_keyword'] = $this->request->post['config_meta_keyword_i18n'][$default_lang_id];
			}
		}

		if (isset($this->request->post['config_name_i18n'])) {
			foreach ($this->request->post['config_name_i18n'] as $language_id => $value) {
				if ((utf8_strlen($value) < 1) || (utf8_strlen($value) > 255)) {
					$this->error['name'][$language_id] = $this->language->get('error_name');
				}
			}
			// Sync default language value to original field
			$default_lang_id = $this->config->get('config_language_id');
			if (isset($this->request->post['config_name_i18n'][$default_lang_id])) {
				$this->request->post['config_name'] = $this->request->post['config_name_i18n'][$default_lang_id];
			}
		}

		if (isset($this->request->post['config_owner_i18n'])) {
			foreach ($this->request->post['config_owner_i18n'] as $language_id => $value) {
			...
			// Sync default language value to original field
			$default_lang_id = $this->config->get('config_language_id');
			if (isset($this->request->post['config_owner_i18n'][$default_lang_id])) {
				$this->request->post['config_owner'] = $this->request->post['config_owner_i18n'][$default_lang_id];
			}
		}

		if (isset($this->request->post['config_address_i18n'])) {
			foreach ($this->request->post['config_address_i18n'] as $language_id => $value) {
				if ((utf8_strlen($value) < 3) || (utf8_strlen($value) > 256)) {
					$this->error['address'][$language_id] = $this->language->get('error_address');
				}
			}
			// Sync default language value to original field
			$default_lang_id = $this->config->get('config_language_id');
			if (isset($this->request->post['config_address_i18n'][$default_lang_id])) {
				$this->request->post['config_address'] = $this->request->post['config_address_i18n'][$default_lang_id];
			}
		}

		if (isset($this->request->post['config_open_i18n'])) {
			$default_lang_id = $this->config->get('config_language_id');
			if (isset($this->request->post['config_open_i18n'][$default_lang_id])) {
				$this->request->post['config_open'] = $this->request->post['config_open_i18n'][$default_lang_id];
			}
		}

		if (isset($this->request->post['config_comment_i18n'])) {
			$default_lang_id = $this->config->get('config_language_id');
			if (isset($this->request->post['config_comment_i18n'][$default_lang_id])) {
				$this->request->post['config_comment'] = $this->request->post['config_comment_i18n'][$default_lang_id];
			}
		}
