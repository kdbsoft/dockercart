...
class ControllerExtensionModuleBanner extends Controller {
	...
	public function index() {
		...
		// expose user token and banner edit base url for template (open edit in new tab)
		$data['user_token'] = $this->session->data['user_token'];
		$data['banner_edit_base'] = $this->url->link('design/banner/edit', 'user_token=' . $this->session->data['user_token'] . '&banner_id=', true);
		$data['banner_list_url'] = $this->url->link('design/banner', 'user_token=' . $this->session->data['user_token'], true);
