...
class ControllerExtensionModuleDockerCartTheme extends Controller {
    ...
    private function getLucideIconOptions() {
        return array(
            ...
            'mail', 'mail-open', 'mail-check', 'mail-x', 'mail-search', 'message-square', 'message-circle',
            'message-square-text', 'message-square-text', 'message-square-text',
            'messages-square', 'send', 'reply', 'reply-all', 'forward',
            'at-sign', 'contact', 'contact-round',

            // Media & Entertainment
            'camera', 'camera-off', 'video', 'video-off', 'image',
            'image-plus', 'image-minus', 'film', 'clapperboard',
            'music', 'music-3', 'mic', 'mic-audio-lines', 'mic-off',
            'radio', 'headphones', 'speaker', 'volume-1', 'volume-2',
            'volume-x', 'monitor-speaker', 'tv', 'monitor', 'tablet',
            'smartphone', 'gamepad-2', 'puzzle',

            // Technology & Devices
            'laptop', 'laptop-minimal', 'computer', 'hard-drive', 'database',
            'cpu', 'memory-stick', 'printer', 'scan-line', 'keyboard',
            'mouse', 'monitor-check', 'monitor-dot', 'monitor-pause',
            'monitor-stop', 'monitor-x', 'watch', 'watch',
            ...
            'file-check', 'file-x', 'file-image',
            'file-archive', 'file-code', 'file-spreadsheet',
            ...
            'circle-chevron-up', 'circle-chevron-down',
            'move-up', 'move-down', 'move-left', 'move-right',
            'arrow-up-down', 'corner-up-left', 'corner-up-right',
            ...
            // UI & Navigation
            'menu', 'square-menu', 'house', 'search', 'search-x',
            'search-check', 'x', 'circle-x', 'check', 'circle-check',
            'circle-check-big', 'square-check', 'plus', 'circle-plus',
            'square-plus', 'minus', 'circle-minus', 'square-minus',
            'trash', 'trash-2', 'pen', 'settings', 'cog',
            'sliders-horizontal', 'sliders-vertical', 'toggle-left',
            'toggle-right', 'funnel', 'list', 'list-checks',
            'list-ordered', 'grid-3x3', 'columns-2', 'rows-2', 'layout-grid',
            'layout-list', 'layout-dashboard', 'panel-left',
            'panel-right', 'panel-top', 'panel-bottom',
            'panel-left', 'panel-left-close', 'panel-left-open',
            ...
            'user-round-x', 'user-round-cog', 'user-round',
            'shield', 'shield-check', 'shield-off', 'shield-alert',
            'shield-ban', 'shield-plus', 'lock', 'lock-open',
            ...
            'cigarette-off', 'citrus', 'clover', 'martini',
            'coffee', 'coins', 'combine', 'cone', 'concierge-bell',
            'cookie', 'cooking-pot', 'cookie', 'copyleft', 'copyright', 'crop', 'cross', 'braces', 'disc-3',
            'donut', 'door-open', 'drama', 'drill', 'droplet',
            'droplet', 'ear', 'ear-off', 'egg', 'egg-fried',
            'egg-off',
            'factory', 'fan', 'fast-forward', 'feather', 'fence',
            'ferris-wheel', 'flag', 'flag-off', 'flashlight',
            'flask-conical', 'flask-round', 'flip-horizontal-2',
            'flip-vertical-2', 'flower', 'focus',
            'fold-horizontal', 'fold-vertical', 'utensils', 'footprints',
            'forklift', 'rectangle-horizontal', 'frame', 'frame', 'frown',
            'funnel', 'gallery-horizontal', 'gallery-vertical',
            'gamepad', 'square-chart-gantt', 'gauge', 'ghost', 'tower-control',
            'glass-water', 'glasses', 'grape', 'grip',
            'grip-horizontal', 'grip-vertical', 'group',
            'ham', 'hammer', 'hand', 'hand-coins', 'hand-heart',
            'hand-helping', 'hand-metal', 'hand-platter',
            'handshake', 'hard-hat', 'hash', 'hat-glasses',
            'heading-1', 'heading-2', 'heading-3', 'heading-4',
            'heading-5', 'heading-6', 'headphones', 'ear',
            'heater', 'hand-helping', 'hexagon', 'person-standing',
            'rotate-ccw-clock', 'hop', 'person-standing', 'hospital', 'hotel',
            'ice-cream-cone', 'ice-cream-bowl', 'ice-cream-cone', 'inbox', 'indian-rupee',
            'inspection-panel', 'italic', 'map',
            'joystick', 'kanban', 'square-dashed-kanban',
            'currency', 'utensils-crossed', 'lamp', 'lamp-ceiling', 'lamp-desk',
            'lamp-floor', 'lamp-wall-down', 'lamp-wall-up',
            'land-plot', 'languages', 'lasso', 'lasso-select',
            'laugh', 'layers', 'layers-2', 'layers-2',
            ...
            'list-video', 'list-x', 'loader', 'loader-circle',
            'loader-pinwheel', 'locate', 'log-in', 'log-out',
            'luggage', 'magnet', 'mailbox', 'mars', 'mars-stroke',
            'martini', 'layout-grid', 'hand-heart', 'hand-metal',
            'maximize-2', 'beef', 'megaphone', 'megaphone-off',
            'memory-stick', 'menu', 'square-menu', 'merge',
            ...
            'monitor-x', 'moon-star', 'ellipsis',
            'ellipsis-vertical', 'mountain', 'mountain-snow',
            'mouse-pointer', 'mouse-pointer-2', 'mouse-pointer-2',
            'mouse-pointer-click', 'move', 'move-3d',
            'move-diagonal', 'move-diagonal-2', 'move-horizontal',
            'move-vertical', 'move', 'landmark', 'music-2',
            'music-4', 'navigation-2-off', 'navigation-off',
            'shirt', 'newspaper', 'nfc', 'non-binary',
            'notebook', 'notebook-pen', 'notebook-text',
            'notepad-text', 'nut', 'nut-off', 'octagon-alert',
            'octagon-minus', 'octagon-pause', 'octagon-x',
            'omega', 'option', 'orbit', 'origami', 'cooking-pot', 'package-minus', 'package-plus',
            'package-search', 'paintbrush', 'paintbrush-vertical',
            'paintbrush-vertical', 'palette',
            ...
            'paw-print', 'pen-line',
            'pen-off', 'pencil-ruler', 'pentagon',
            'percent', 'person-standing', 'philippine-peso',
            ...
            'plane-takeoff', 'play', 'plug-2', 'plug-zap',
            'plus', 'pocket-knife', 'pocket-knife',
            'pointer', 'pointer-off', 'popcorn', 'popsicle',
            'pound-sterling', 'circle-power', 'square-power',
            'presentation', 'printer-check', 'printer-x',
            'projector', 'proportions', 'puzzle', 'qr-code',
            'quote', 'radar', 'radio-receiver', 'carrot',
            'rainbow', 'rat', 'baby', 'recycle',
            ...
            'router', 'rows-2', 'rows-2', 'rows-3', 'rows-4',
            ...
            'spline', 'split', 'square-split-horizontal',
            'square-split-vertical', 'spray-can', 'sprout',
            ...
            'square-arrow-up', 'square-asterisk',
            ...
            'square-function', 'square-chart-gantt', 'square-kanban',
            ...
            'square-plus', 'square-power', 'square-radical', 'square-sigma', 'square-slash',
            ...
            'strikethrough', 'subscript', 'candy-cane',
            ...
            'square-terminal', 'test-tube-diagonal', 'test-tubes',
            'text-cursor-input', 'text-cursor', 'text-cursor-input',
            'text-quote', 'text-search', 'text-cursor',
            ...
            'triangle-alert', 'triangle-right',
            'triangle', 'trophy', 'truck', 'trash-2', 'turtle', 'tv-minimal', 'tv-minimal-play',
            'type', 'umbrella-off',
            ...
            'utility-pole', 'washing-machine', 'variable',
            'vault', 'vegan', 'venetian-mask', 'venus',
            'venus-and-mars', 'venus-and-mars', 'badge-check',
            ...
            'washing-machine', 'watch', 'waypoints',
