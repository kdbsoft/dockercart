...
class ControllerCatalogOptionSet extends Controller {
	...
	protected function getList() {
		...
		$data['results'] = sprintf($this->language->get('text_pagination'), ($option_set_total) ? (($page - 1) * $this->config->get('config_limit_admin')) + 1 : 0, ((($page - 1) * $this->config->get('config_limit_admin')) > ($option_set_total - $this->config->get('config_limit_admin'))) ? $option_set_total : ((($page - 1) * $this->config->get('config_limit_admin')) + $this->config->get('config_limit_admin')), $option_set_total, ceil($option_set_total / $this->config->get('config_limit_admin')));
