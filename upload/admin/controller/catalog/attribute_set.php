...
class ControllerCatalogAttributeSet extends Controller {
	...
	protected function getList() {
		...
		$data['results'] = sprintf($this->language->get('text_pagination'), ($attribute_set_total) ? (($page - 1) * $this->config->get('config_limit_admin')) + 1 : 0, ((($page - 1) * $this->config->get('config_limit_admin')) > ($attribute_set_total - $this->config->get('config_limit_admin'))) ? $attribute_set_total : ((($page - 1) * $this->config->get('config_limit_admin')) + $this->config->get('config_limit_admin')), $attribute_set_total, ceil($attribute_set_total / $this->config->get('config_limit_admin')));
