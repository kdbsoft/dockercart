...
$_['help_full_width'] = 'Відображати вміст сторінки без обмеження ширини, на весь екран.';
...
$_['text_list_subtitle'] = 'Керуйте сторінками інформації';
...
// Empty state
$_['text_empty_title']       = 'Поки немає інформаційних сторінок';
$_['text_empty_description'] = 'Додайте статичні сторінки, як-от «Про нас» або «Умови». Створіть першу сторінку.';
