...
$_['entry_banner_select'] = 'Банер категорії';
$_['text_banner_none'] = '— Немає банера —';
$_['text_banner_inactive'] = 'вимкнено';
...
$_['help_banner_image'] = 'Показує рекламний банер у списку товарів категорії. Банер створюється в розділі Дизайн → Банери та рендериться з першого слайда.';
...
// Empty state
$_['text_empty_title']       = 'Поки немає категорій';
$_['text_empty_description'] = 'Категорії допомагають організувати товари у зрозуміле дерево. Створіть першу категорію, щоб почати.';
