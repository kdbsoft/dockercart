...
$_["entry_show_warehouse"] = "Показувати склад відвантаження";
$_["help_show_warehouse"] =
    "Відображати склад відвантаження (Відправляється з) для кожного товару в блоці замовлення на сторінці оформлення. Вимкніть, щоб приховати інформацію про склади для покупців.";
$_["entry_show_product_code"] = "Показувати код товару (Модель)";
$_["help_show_product_code"] =
    "Відображати код товару (Модель) для кожного товару в блоці замовлення на сторінці оформлення. Вимкніть, щоб приховати коди товарів для покупців.";
...
$_["block_coupon"] = "Промо-код / Ваучер / Бонусні бали";
...
$_["text_order_totals"] = "Підсумки в замовленні";
$_["text_order_totals_help"] = "Керуйте тим, які підсумки розраховуються у зведенні замовлення та в якому порядку: проміжний підсумок, купони, доставка, податки тощо. Встановлюйте, вмикайте/вимикайте, змінюйте порядок розрахунку або налаштовуйте кожен підсумок.";
$_["column_total_sort_order"] = "Порядок";
$_["column_total_status"] = "Увімкнено";
$_["text_total_not_installed"] = "Не встановлено";
$_["text_no_order_totals"] = "Розширення підсумків замовлення не знайдено.";
$_["button_total_install"] = "Встановити";
$_["button_total_uninstall"] = "Видалити";
$_["text_confirm_uninstall"] = "Ви впевнені, що хочете видалити цей підсумок замовлення?";
$_["error_invalid_total_code"] = "Невірний код підсумку замовлення!";

$_["text_total_estimator"] = "Калькулятор доставки";
$_["help_total_estimator"] = "Показувати калькулятор вартості доставки на сторінці кошика";
$_["text_total_min_total"] = "Замовлення від";
$_["text_total_fee"] = "Збір";
$_["text_total_tax_class"] = "Податковий клас";
$_["text_drag_to_reorder"] = "Потягніть, щоб змінити порядок";
