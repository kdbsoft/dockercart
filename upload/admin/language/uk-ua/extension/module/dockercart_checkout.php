...
$_["error_permission"] =
    "Увага: У вас немає дозволу на зміну DockerCart Checkout!";
...
$_["help_custom_css"] =
    "Додайте власні стилі CSS, щоб налаштувати зовнішній вигляд оформлення замовлення";
$_["help_custom_js"] =
    "Додайте власний код JavaScript (ES6+) для додаткової функціональності";
$_["help_debug"] =
    "Увімкнути журналювання налагодження для усунення несправностей";
$_["help_geo_detect"] =
    "Автоматичне визначення міста/регіону клієнта на основі IP-адреси";
$_["help_guest_create_account"] =
    "Дозволити клієнтам-гостям за бажанням створювати обліковий запис під час оформлення замовлення";
$_["help_journal3_compat"] =
    "Увімкнути спеціальні налаштування стилю для теми Journal 3";
$_["help_license_key"] = "У GPL-версії ліцензійний ключ не потрібен";
...
$_["help_required_fields"] =
    'Налаштуйте, які поля обов\'язкові під час оформлення замовлення';
$_["help_show_progress"] =
    "Відображати візуальний індикатор прогресу у верхній частині оформлення замовлення";
$_["help_status"] =
    "Увімкнення або вимкнення модуля оформлення замовлення DockerCart";
...
$_["text_comment_placeholder"] =
    "Додайте примітку до замовлення, наприклад побажання щодо доставки.";
...
$_["text_blocks_info"] =
    "Перетягніть, щоб змінити порядок блоків оформлення замовлення. Натисніть «Налаштувати», щоб керувати полями в кожному блоці.";
...
$_["text_method_overrides_help"] =
    "Увімкніть та налаштуйте назви й описи для певних способів доставки та оплати. Залиште поля порожніми, щоб використовувати значення за замовчуванням.";
$_["text_modal_instructions"] =
    "Перетягніть поля, щоб змінити порядок • Перемикайте перемикачі, щоб показати/приховати або встановити потрібні налаштування";
$_["text_no"] = "Ні";
$_["text_no_fields"] = "Немає налаштованих полів";
$_["text_no_fields_in_row"] = "У цьому рядку немає полів";
$_["text_no_methods_available"] =
    "Немає доступних методів. Переконайтеся, що розширення доставки/оплати встановлено та ввімкнено.";
...
$_["text_success"] =
    "Успіх: Ви змінили налаштування оформлення замовлення в DockerCart!";
