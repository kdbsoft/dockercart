...
$_['entry_line_cost'] = 'Ціна закупівлі';
$_['help_line_cost'] = 'Закупівельна ціна за одиницю у постачальника, у валюті магазину за замовчуванням. Порожнє значення — очистити.';
$_['error_permission'] = 'Увага: У вас немає прав для зміни замовлень постачальникам!';
$_['error_action'] = 'Некоректний запит!';
$_['error_cost'] = 'Некоректна ціна закупівлі!';
$_['error_not_dropship'] = 'Рядок не належить до дропшип-постачальника!';
