...
$_['error_order_not_found'] = 'Увага: Замовлення не знайдено!';
$_['error_reward_no_customer'] = 'Увага: У замовлення немає облікового запису клієнта!';
$_['error_reward_no_points'] = 'Увага: У замовленні немає бонусних балів!';
$_['error_reward_exists'] = 'Увага: Бонусні бали вже нараховано!';
$_['error_commission_no_affiliate'] = 'Увага: У замовлення немає реферала!';
$_['error_commission_exists'] = 'Увага: Комісію вже нараховано!';
...
$_['text_reward_refunded'] = 'Повернення по замовленню #%s';
...
$_['text_reward_awarded'] = 'Нараховано: %s';
$_['text_reward_pending'] = 'Нарахування очікується (відкладено)';
...
$_['text_sku'] = 'Артикул:';
$_['text_variant_model']         = 'Модель варіанта:';
$_['text_variant_sku']           = 'Артикул варіанта:';
$_['text_variant_upc']           = 'UPC варіанта:';
$_['text_variant_ean']           = 'EAN варіанта:';
$_['text_variant_jan']           = 'JAN варіанта:';
$_['text_variant_isbn']          = 'ISBN варіанта:';
$_['text_variant_mpn']           = 'MPN варіанта:';
...
$_['text_select_customer_group'] = 'Вибір групи покупця';
$_['entry_select_group']         = 'Група покупця для нового замовлення';
...
// Модальні вікна статусів у списку замовлень
$_['text_list_status_title']     = 'Змінити статус замовлення — №%s';
$_['text_list_payment_title']    = 'Оплати — замовлення №%s';
$_['text_list_shipment_title']   = 'Відвантаження — замовлення №%s';
$_['text_list_status_current']   = 'Поточний статус';
$_['text_list_status_new']       = 'Новий статус';
$_['text_list_status_empty']     = 'Немає доступних переходів з цього статусу. Увімкніть примусову зміну.';
$_['text_list_refund_hint']      = 'Повернення оформлюються на сторінці замовлення.';
$_['text_list_payment_hint']     = 'Статус оплати розраховується із записаних оплат — тих самих, що на сторінці замовлення.';
$_['text_list_shipment_hint']    = 'Статус відвантаження розраховується з відвантажень — тих самих, що на сторінці замовлення.';
$_['text_list_status_change']    = 'Змінити статус';
$_['text_list_payment_change']   = 'Змінити оплату';
$_['text_list_shipment_change']  = 'Змінити відвантаження';
$_['button_open_order']          = 'Відкрити замовлення';
...
$_['button_invoice']             = 'Рахунок до оплати';
$_['text_invoice']               = 'Рахунок до оплати';
$_['text_invoice_valid_until']   = 'Рахунок дійсний до';
$_['text_balance_due']           = 'Залишок до оплати';
$_['text_paid_amount']           = 'Сплачено';
$_['text_payment_history']       = 'Історія платежів';
$_['text_seller']                = 'Продавець';
$_['text_bill_to']               = 'Покупець';
...
$_['text_payment_order_recipient'] = 'Отримувач';
$_['text_payment_order_bank']    = 'Банк отримувача';
$_['text_payment_order_payer']   = 'Платник';
$_['text_payment_order_tax']     = 'ІПН';
$_['text_payment_order_account'] = 'Рахунок';
$_['text_payment_order_purpose'] = 'Призначення платежу';
$_['text_payment_order_amount']  = 'Сума';
$_['text_payment_purpose']       = 'Оплата за рахунком %s';

// Seller tax number type labels (code => label)
$_['text_tax_type_VAT']        = 'ПДВ';
$_['text_tax_type_EIN']        = 'ІПН роботодавця (EIN)';
$_['text_tax_type_TIN']        = 'ІПН (TIN)';
$_['text_tax_type_ABN']        = 'ABN';
$_['text_tax_type_GST']        = 'GST';
$_['text_tax_type_EDRPOU']     = 'ЄДРПОУ';
$_['text_tax_type_IPN']        = 'ІПН';
...
$_['text_price_override']        = 'Ціну змінено вручну';
$_['button_restore_catalog_price'] = 'Повернути ціну з каталогу';
...
$_['text_no_customers'] = 'Клієнтів не знайдено';
...
$_['text_refund_modal_title']        = 'Повернення коштів';
$_['text_refund_modal_sub']          = 'Оберіть позиції, суму та причину, потім підтвердіть.';
$_['text_refund_items']              = 'Позиції';
$_['text_refund_amount']             = 'Сума повернення';
$_['text_refund_restock']            = 'Повернути залишок на склад';
$_['text_refund_notify']             = 'Сповістити клієнта';
$_['text_refund_processed']          = 'Повернення коштів проведено!';
$_['error_refund_no_items']          = 'Оберіть хоча б одну позицію для повернення!';
$_['error_refund_reason']            = 'Вкажіть причину повернення!';
$_['button_refund_confirm']          = 'Оформити повернення';
