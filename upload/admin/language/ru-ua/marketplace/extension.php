...
$_['text_ext_count']     = '%s дополнение';
$_['text_ext_count_plural'] = '%s дополнений';
$_['text_ext_shown']     = 'показано %s';
$_['text_ext_short']     = 'доп.';
$_['text_confirm']           = 'Вы уверены, что хотите удалить это дополнение?';
$_['text_confirm_instance']  = 'Вы уверены, что хотите удалить этот экземпляр модуля?';
$_['text_enabled']       = 'Включено';
$_['text_disabled']      = 'Отключено';
$_['text_official']      = 'Официальное';
$_['text_system']        = 'Системное';
$_['text_home']          = 'Главная';
// Subtitle
...
$_['error_system_extension'] = 'Предупреждение: Это системное дополнение, его нельзя удалить!';
