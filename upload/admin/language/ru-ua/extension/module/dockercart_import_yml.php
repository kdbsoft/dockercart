...
$_['help_cg_price_mapping'] = 'Укажите теги YML (прямые дочерние элементы offer, например "price2", "price_wholesale") которые содержат цены для групп покупателей. Основной тег <price> всегда импортируется как базовая цена.';
