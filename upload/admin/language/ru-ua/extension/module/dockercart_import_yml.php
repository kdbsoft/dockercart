...
$_['help_cg_price_mapping'] = 'Укажите теги YML (прямые дочерние элементы offer, например "price2", "price_wholesale") которые содержат цены для групп покупателей. При использовании этого маппинга обязательно укажите тег основной цены в поле "Тег основной цены" выше.';
