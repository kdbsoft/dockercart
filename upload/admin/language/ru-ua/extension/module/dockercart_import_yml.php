...
$_['button_add_mapping'] = 'Добавить маппинг';
...
$_['entry_cg_price_mapping'] = 'Цены для групп покупателей';
$_['entry_main_price_tag'] = 'Тег основной цены';
$_['entry_cg_mapping_tag'] = 'Тег YML';
$_['entry_cg_mapping_group'] = 'Группа покупателей';
$_['entry_cg_mapping_currency_tag'] = 'Тег валюты';
...
$_['error_permission'] = 'Внимание: У вас нет прав для изменения настроек Импорт YML!';
...
$_['help_cg_price_mapping'] = 'Укажите теги YML (прямые дочерние элементы offer, например "price2", "price_wholesale") которые содержат цены для групп покупателей. По желанию укажите "Тег валюты" — название тега YML (например "currency1", "curr"), который содержит код валюты для этой цены. Если валюта отличается от валюты профиля, цена будет конвертирована по курсу из фида или магазина. При использовании этого маппинга обязательно укажите тег основной цены в поле "Тег основной цены" выше.';
$_['help_main_price_tag'] = 'Тег YML, используемый как базовая цена товара. По умолчанию "price". Обязателен, когда настроен маппинг цен для групп покупателей, так как некоторые фиды могут не иметь стандартного тега <price>, а использовать теги "price1", "price2" и т.д.';
...
$_['text_success'] = 'Успешно: Вы изменили настройки модуля Импорт YML!';
