...
$_["error_permission"] =
    "Внимание: У вас нет прав на изменение модуля Checkout!";
...
$_["help_custom_css"] =
    "Добавьте свои CSS-стили для настройки внешнего вида чекаута";
$_["help_custom_js"] =
    "Добавьте свой JavaScript-код (ES6+) для дополнительной функциональности";
$_["help_debug"] = "Включить логирование для диагностики проблем";
$_["help_geo_detect"] =
    "Автоматически определять город/регион клиента по IP-адресу";
$_["help_guest_create_account"] =
    "Разрешить гостевым покупателям создать аккаунт во время оформления заказа";
$_["help_journal3_compat"] = "Включить специальные стили для темы Journal 3";
$_["help_license_key"] = "В GPL-версии лицензионный ключ не требуется";
...
$_["help_show_progress"] =
    "Отображать визуальный индикатор прогресса вверху страницы оформления заказа";
...
$_["text_comment_placeholder"] =
    "Напишите примечание к заказу, например пожелания по доставке.";
...
$_["text_method_overrides"] =
    "Переопределение названий и описаний методов доставки и оплаты";
$_["text_method_overrides_help"] =
    "Включите и настройте названия и описания для конкретных методов доставки и оплаты. Оставьте поля пустыми для использования значений по умолчанию.";
...
$_["text_no_methods_available"] =
    "Методы недоступны. Пожалуйста, убедитесь, что расширения доставки/оплаты установлены и включены.";
...
$_["text_success"] = "Настройки модуля Checkout успешно сохранены!";
