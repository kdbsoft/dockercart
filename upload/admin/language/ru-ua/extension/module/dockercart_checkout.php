...
$_["entry_show_warehouse"] = "Показывать склад отгрузки";
$_["help_show_warehouse"] =
    "Отображать склад отгрузки (Отправляется с) для каждого товара в блоке заказа на странице оформления. Отключите, чтобы скрыть информацию о складах для покупателей.";
$_["entry_show_product_code"] = "Показывать код товара (Модель)";
$_["help_show_product_code"] =
    "Отображать код товара (Модель) для каждого товара в блоке заказа на странице оформления. Отключите, чтобы скрыть коды товаров для покупателей.";
...
$_["block_coupon"] = "Промо-код / Сертификат / Бонусы";
...
// Sidebar
$_["text_sidebar_status"] = "Состояние модуля";
$_["text_sidebar_nav"] = "Разделы";
$_["text_sidebar_about"] = "О модуле";
$_["text_module_always_active"] =
    "Это системный модуль и всегда включён.";

$_["text_info"] =
    "<strong>DockerCart Checkout</strong> — бесплатный модуль одностраничного оформления заказа для DockerCart.<br><strong>Лицензия:</strong> GNU GPL v3.0<br><br><strong>Возможности:</strong><br>✓ Современное, быстрое одностраничное оформление заказа<br>✓ Адаптивный дизайн (mobile-first)<br>✓ Работа через AJAX (без перезагрузки страницы)<br>✓ Drag & Drop настройка блоков<br>✓ Гостевое оформление заказа с опциональной регистрацией<br>✓ Поддержка всех методов доставки/оплаты<br>✓ Промо-коды, сертификаты, бонусные баллы<br>✓ Маска телефона и валидация в реальном времени<br>✓ Светлая/Тёмная темы + произвольный CSS<br>✓ Совместимость с Journal 3<br>✓ Без OCMOD — установка через систему событий";
