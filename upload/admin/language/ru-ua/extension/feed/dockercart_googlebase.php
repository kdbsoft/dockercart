...
$_['entry_custom_label_0'] = 'Пользовательская метка 0';
$_['entry_custom_label_1'] = 'Пользовательская метка 1';
$_['entry_custom_label_2'] = 'Пользовательская этикетка 2';
$_['entry_custom_label_3'] = 'Пользовательская этикетка 3';
$_['entry_custom_label_4'] = 'Пользовательская этикетка 4';
...
$_['error_permission'] = 'Предупреждение: У вас нет прав на изменение Google Base!';
...
$_['help_schedule'] = 'Автоматическое расписание регенерации фида';
...
$_['text_success'] = 'Успех: Вы изменили настройки модуля Google Base!';
