...
$_['error_model'] = 'Модель товара должна содержать более 3 и менее 64 символов!';
...
$_['text_list_subtitle'] = 'Управляйте возвратами товаров';

$_['text_filter_subtitle'] = 'Сузить результаты по критериям';

$_['text_add_return_subtitle'] = 'Оформить новый возврат товара';
...
// Empty state
$_['text_empty_title']       = 'Пока нет возвратов';
$_['text_empty_description'] = 'Возвраты товаров от покупателей появятся здесь. Сейчас обрабатывать нечего.';
