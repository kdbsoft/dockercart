<?php
// Text
$_['text_success']     = 'Success: You have modified add-ons!';
...
$_['error_module_active'] = 'Warning: Extension %s is still active in Add-ons &gt; Modules. Please uninstall it there first.';