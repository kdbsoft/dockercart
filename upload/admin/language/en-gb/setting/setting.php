...
$_['text_auth_login']                = 'Login (Username & Password)';
$_['text_auth_oauth']                = 'OAuth 2.0 (Access Token)';
...
$_['entry_account_download_status']    = 'Enable Account Downloads';
...
$_['entry_stock_reserve_enabled']    = 'Reserve Stock At Checkout';
$_['entry_stock_reserve_minutes']    = 'Reserve Duration (minutes)';
$_['entry_stock_reserve_stale_days'] = 'Stale Order Hold Release (days)';
$_['entry_warehouse_enabled']         = 'Enable Multi-Warehouse';
$_['entry_warehouse_split_allowed']   = 'Allow Split Shipments';
$_['entry_warehouse_stock_display']   = 'Show Warehouse Stock';
$_['entry_warehouse_show_pickup']     = 'Show Pickup Options';
$_['entry_warehouse_estimate_enabled'] = 'Enable Delivery Estimates';
$_['entry_warehouse_dropship_checkout'] = 'Allow Dropshipping at Checkout';
$_['entry_affiliate_status']          = 'Enable Affiliate Program';
...
$_['entry_mail_smtp_auth_method']    = 'SMTP Auth Method';
...
$_['entry_product_cache_status']      = 'Enable Product Cache';
...
$_['help_account_download_status']     = 'Allow customers to access the downloads page in their account.';
...
$_['help_stock_reserve_enabled']     = 'Hold the ordered products when a customer starts checkout, so other customers cannot buy the last items during the reservation window. Holds are released automatically after the duration below (cleaned by the scheduler) and bound to the order once it is created, until stock is subtracted or the order is cancelled. Not active when Stock Checkout is enabled.';
$_['help_stock_reserve_minutes']     = 'How long (in minutes) items stay reserved when a customer enters the checkout flow. Each visit to the checkout page refreshes the window. A payment method can override this with its own reserve duration.';
$_['help_stock_reserve_stale_days']  = 'After how many days without changes the scheduler releases holds of orders that never reached a processing/complete status (safety net for abandoned orders). 0 = disabled.';
$_['help_warehouse_enabled']         = 'Enable multi-warehouse stock tracking. Assigns each order line to a warehouse and powers warehouse-based shipping, pickup and stock display.';
$_['help_warehouse_split_allowed']   = 'Allow an order to be fulfilled from several warehouses when no single warehouse covers the whole cart. If disabled, the order is assigned to the warehouse that can fulfil the most items.';
$_['help_warehouse_stock_display']   = 'Show per-warehouse stock availability on the product page.';
$_['help_warehouse_show_pickup']     = 'Show in-store / curbside pickup availability for physical warehouses on the product page and at checkout.';
$_['help_warehouse_estimate_enabled'] = 'Show delivery time estimates from the nearest suitable warehouse in the shipping method list at checkout.';
$_['help_warehouse_dropship_checkout'] = 'Include dropship warehouses when selecting the fulfilling warehouse at checkout.';
$_['help_affiliate_status']          = 'Enable or disable the affiliate program across the entire storefront. Disabled by default.';
...
$_['help_mail_engine']               = 'Only SMTP is supported. PHP mail() has been disabled.';
...
$_['help_mail_smtp_auth_method']     = 'Choose \'Login\' for username/password authentication, or \'OAuth 2.0\' for token-based authentication (Gmail, Outlook).';
$_['help_mail_smtp_oauth_token']     = 'Current OAuth 2.0 access token. Updated automatically after token refresh.';
...
$_['help_robots']                    = 'A list of web crawler user agents. Product view tracking will be skipped for matching bots. Use separate lines for each user agent.';
...
$_['help_product_cache_status']       = 'Cache full product data in model getProduct() for 1 hour. Disabled by default.';
...
$_['error_stock_reserve_stale_days'] = 'Stale order hold release must be 0 or a positive number of days!';
