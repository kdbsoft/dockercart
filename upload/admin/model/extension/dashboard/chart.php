...
class ModelExtensionDashboardChart extends Model {
	...
	public function getRevenueByDay() {
		...
		$query = $this->db->query("SELECT SUM(total / currency_value) AS total, HOUR(date_added) AS hour FROM `" . DB_PREFIX . "order` WHERE order_status_id IN(" . implode(",", $implode) . ") AND DATE(date_added) = DATE(NOW()) GROUP BY HOUR(date_added) ORDER BY date_added ASC");
	...
	public function getRevenueByWeek() {
		...
		$query = $this->db->query("SELECT SUM(total / currency_value) AS total, date_added FROM `" . DB_PREFIX . "order` WHERE order_status_id IN(" . implode(",", $implode) . ") AND DATE(date_added) >= DATE('" . $this->db->escape(date('Y-m-d', $date_start)) . "') GROUP BY DAYNAME(date_added)");
	...
	public function getRevenueByMonth() {
		...
		$query = $this->db->query("SELECT SUM(total / currency_value) AS total, date_added FROM `" . DB_PREFIX . "order` WHERE order_status_id IN(" . implode(",", $implode) . ") AND DATE(date_added) >= DATE('" . $this->db->escape(date('Y') . '-' . date('m') . '-1') . "') GROUP BY DATE(date_added)");
	...
	public function getRevenueByYear() {
		...
		$query = $this->db->query("SELECT SUM(total / currency_value) AS total, date_added FROM `" . DB_PREFIX . "order` WHERE order_status_id IN(" . implode(",", $implode) . ") AND YEAR(date_added) = YEAR(NOW()) GROUP BY MONTH(date_added)");
	...
	public function getPendingOrdersByDay() {
		...
		$query = $this->db->query("SELECT COUNT(*) AS total, HOUR(date_added) AS hour FROM `" . DB_PREFIX . "order` WHERE order_status_id NOT IN(" . implode(",", $implode) . ") AND order_status_id != '0' AND DATE(date_added) = DATE(NOW()) GROUP BY HOUR(date_added) ORDER BY date_added ASC");
	...
	public function getPendingOrdersByWeek() {
		...
		$query = $this->db->query("SELECT COUNT(*) AS total, date_added FROM `" . DB_PREFIX . "order` WHERE order_status_id NOT IN(" . implode(",", $implode) . ") AND order_status_id != '0' AND DATE(date_added) >= DATE('" . $this->db->escape(date('Y-m-d', $date_start)) . "') GROUP BY DAYNAME(date_added)");
	...
	public function getPendingOrdersByMonth() {
		...
		$query = $this->db->query("SELECT COUNT(*) AS total, date_added FROM `" . DB_PREFIX . "order` WHERE order_status_id NOT IN(" . implode(",", $implode) . ") AND order_status_id != '0' AND DATE(date_added) >= DATE('" . $this->db->escape(date('Y') . '-' . date('m') . '-1') . "') GROUP BY DATE(date_added)");
	...
	public function getPendingOrdersByYear() {
		...
		$query = $this->db->query("SELECT COUNT(*) AS total, date_added FROM `" . DB_PREFIX . "order` WHERE order_status_id NOT IN(" . implode(",", $implode) . ") AND order_status_id != '0' AND YEAR(date_added) = YEAR(NOW()) GROUP BY MONTH(date_added)");
