...
class ModelCatalogProduct extends Model
{
    public function addProduct($data)
    {
        $this->db->query(
            "INSERT INTO " .
                ...
                "', ean = '" .
                $this->db->escape($data["ean"]) .
                "', jan = '" .
                $this->db->escape($data["jan"]) .
                "', isbn = '" .
                ...
                if (
                    ...
                    $this->db->query(
                        "INSERT INTO " .
                            ...
                            (int) $product_option["option_id"] .
                            "', value = '" .
                            $this->db->escape($product_option["value"]) .
                            "', required = '" .
                            (int) $product_option["required"] .
                            "'",
                    );
        ...
        if (isset($data["product_customer_group_price"])) {
            foreach (
                ...
                as $product_customer_group_price
            ) {
                $this->db->query(
                    "INSERT INTO " .
                        DB_PREFIX .
                        "dockercart_product_customer_group_price SET product_id = '" .
                        (int) $product_id .
                        "', customer_group_id = '" .
                        (int) $product_customer_group_price[
                            "customer_group_id"
                        ] .
                        "', price = '" .
                        (float) $product_customer_group_price["price"] .
                        "'",
                );
            }
        }
        ...
        if (isset($data["product_reward"])) {
            foreach (
                $data["product_reward"]
                as $customer_group_id => $product_reward
            ) {
    ...
    public function editProduct($product_id, $data)
    {
        ...
        $this->db->query(
            "DELETE FROM " .
                DB_PREFIX .
                "seo_url WHERE query = 'product_id=" .
                (int) $product_id .
                "'",
        );
        $seo_url_updated = true;
    ...
    public function copyProduct($product_id)
    {
        ...
        if ($query->num_rows) {
            ...
            $data["product_description"] = $this->getProductDescriptions(
                $product_id,
            );
    ...
    public function deleteProduct($product_id)
    {
        ...
        $this->db->query(
            "DELETE FROM " .
                DB_PREFIX .
                "coupon_product WHERE product_id = '" .
                (int) $product_id .
                "'",
        );
    ...
    public function getProduct($product_id)
    {
        $query = $this->db->query(
            "SELECT DISTINCT * FROM " .
                ...
                "product p LEFT JOIN " .
                DB_PREFIX .
                "product_description pd ON (p.product_id = pd.product_id) WHERE p.product_id = '" .
                (int) $product_id .
                "' AND pd.language_id = '" .
    ...
    public function getProductsByCategoryId($category_id)
    {
        $query = $this->db->query(
            "SELECT * FROM " .
                ...
                DB_PREFIX .
                "product_to_category p2c ON (p.product_id = p2c.product_id) WHERE pd.language_id = '" .
                (int) $this->config->get("config_language_id") .
                "' AND p2c.category_id = '" .
                (int) $category_id .
    ...
    public function getProductAttributes($product_id)
    {
        ...
        foreach ($product_attribute_query->rows as $product_attribute) {
            ...
            foreach (
                $product_attribute_description_query->rows
                as $product_attribute_description
            ) {
                $product_attribute_description_data[
                    $product_attribute_description["language_id"]
    ...
    public function getProductOptions($product_id)
    {
        ...
        $product_option_query = $this->db->query(
            "SELECT * FROM `" .
                ...
                DB_PREFIX .
                "option_description` od ON (o.option_id = od.option_id) WHERE po.product_id = '" .
                (int) $product_id .
                "' AND od.language_id = '" .
                (int) $this->config->get("config_language_id") .
    ...
    public function getProductRewards($product_id)
    {
        ...
        foreach ($query->rows as $result) {
            $product_reward_data[$result["customer_group_id"]] = [
    ...
    public function getProductSeoUrls($product_id)
    {
        ...
        foreach ($query->rows as $result) {
            $product_seo_url_data[$result["store_id"]][$result["language_id"]] =
                $result["keyword"];
        }
    ...
    public function getTotalProductsByDownloadId($download_id)
    {
        $query = $this->db->query(
            "SELECT COUNT(*) AS total FROM " .
                DB_PREFIX .
                "product_to_download WHERE download_id = '" .
                (int) $download_id .
                "'",
        );
    ...
    public function getTotalProductsByAttributeId($attribute_id)
    {
        $query = $this->db->query(
            "SELECT COUNT(*) AS total FROM " .
                DB_PREFIX .
                "product_attribute WHERE attribute_id = '" .
                (int) $attribute_id .
                "'",
        );
    ...
    public function getTotalProductsByLayoutId($layout_id)
    {
        $query = $this->db->query(
            "SELECT COUNT(*) AS total FROM " .
                DB_PREFIX .
                "product_to_layout WHERE layout_id = '" .
                (int) $layout_id .
                "'",
        );
