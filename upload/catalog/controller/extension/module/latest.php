...
class ControllerExtensionModuleLatest extends Controller {
	public function index($setting) {
		...
		// Prepare wishlist ids similar to Featured so quick view/in_wishlist state works
		$wishlist_ids = array();
		...
		if ($results) {
			...
			$data['section_title'] = $this->language->get('text_section_title');
			// Link to the New Arrivals page (uses product/new_arrivals controller/template)
			$data['section_href'] = $this->url->link('product/new_arrivals');
