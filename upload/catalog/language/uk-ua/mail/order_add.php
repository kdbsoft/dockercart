...
$_['text_download'] = 'Після підтвердження оплати ви можете перейти за посиланням нижче, щоб отримати доступ до товарів, які можна завантажити:';
...
$_['text_greeting'] = 'Дякуємо за ваш інтерес до товарів %s. Ваше замовлення отримано та буде оброблено після підтвердження оплати.';
